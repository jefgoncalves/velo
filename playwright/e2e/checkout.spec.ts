...
test.describe('Checkout', () => {
  ...
  test.describe('Validações de campos obrigatórios', () => {
    ...
    test('deve exibir erro para telefone com formato inválido', async ({ app }) => {
      const customer = {
        name: 'Fernando',
        lastname: 'Papito',
    ...
    test('deve exibir erro para CPF com formato inválido', async ({ app }) => {
      const customer = {
        name: 'Fernando',
        lastname: 'Papito',
        email: 'papito@velo.dev',
    ...
    test('deve exibir erro quando a loja não for selecionada', async ({ app }) => {
      const customer = {
        name: 'Fernando',
        lastname: 'Papito',
        email: 'papito@velo.dev',
    ...
    test('deve exibir erro quando os termos não forem aceitos', async ({ app }) => {
      const customer = {
        name: 'Fernando',
        lastname: 'Papito',
        email: 'papito@velo.dev',
