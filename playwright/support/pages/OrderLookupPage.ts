...
// 1. Contrato de dados estabelecido (Interface exportada)
export interface OrderDetails {
  number: string;
  status: OrderStatus;
  color: string;
  wheels: string; // Correção estrutural
  customer: {
    name: string;
    email: string;
  };
...
export class OrderLockupPage {
  ...
  // 2. Método exigido pelo hook beforeEach do pedidos.spec.ts
  ...
  // 3. Tipagem forte aplicada, abandonando o "any"
